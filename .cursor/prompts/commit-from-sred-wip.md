...
1. Propose a conventional commit **subject** and **body** describing the change for humans.
2. Apply `.cursorrules` SR&ED Mandatory Pre-Check; append either the full **SRED TECHNICAL LOG** (only if rules satisfied and WIP supports it) or exactly: `SRED: Not applicable (routine work)`.
